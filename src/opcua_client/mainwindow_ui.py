...
# Form implementation generated from reading ui file 'src/opcua_client/mainwindow_ui.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("src/opcua_client/../network.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
